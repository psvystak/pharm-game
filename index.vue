...
<!--			<p style="position: relative; z-index: 100500; color: black; font-size: 24px">Coraxan</p>-->
			<img class="game-pharm-animation-image game-pharm-coraxan-shadow game-pharm-patient-shadow" src="images/coraxan-animation/shadow.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-coraxan-torso2" src="images/coraxan-animation/torso2.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-coraxan-chair" src="images/coraxan-animation/chair.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-coraxan-left-hand" src="images/coraxan-animation/left-hand.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-coraxan-right-hand" src="images/coraxan-animation/right-hand.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-coraxan-right-leg" src="images/coraxan-animation/right-leg.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-coraxan-left-leg" src="images/coraxan-animation/left-leg.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-coraxan-torso3" src="images/coraxan-animation/torso3.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-coraxan-torso" src="images/coraxan-animation/torso.png" alt="Part of the patient">
			<div class="game-pharm-animation-image game-pharm-coraxan-head-wrapper">
				<img class="game-pharm-animation-image game-pharm-coraxan-head" src="images/coraxan-animation/head.png" alt="Part of the patient">
				<img class="game-pharm-animation-image game-pharm-coraxan-eyes" src="images/coraxan-animation/eyes.png" alt="Part of the patient">
				<img class="game-pharm-animation-image game-pharm-coraxan-glasses" src="images/coraxan-animation/glasses.png" alt="Part of the patient">
			</div>
		</div>
...
<!--			<p style="position: relative; z-index: 100500; color: black; font-size: 24px">Prestilol</p>-->
			<img class="game-pharm-animation-image game-pharm-prestilol-shadow game-pharm-patient-shadow" src="images/prestilol-animation/shadow.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-prestilol-legs" src="images/prestilol-animation/legs.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-prestilol-right-hand" src="images/prestilol-animation/right-hand.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-prestilol-torso" src="images/prestilol-animation/torso.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-prestilol-left-hand" src="images/prestilol-animation/left-hand.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-prestilol-head" src="images/prestilol-animation/head.png" alt="Part of the patient">
		</div>
...
<!--			<p style="position: relative; z-index: 100500; color: black; font-size: 24px">Triplixam</p>-->
			<img class="game-pharm-animation-image game-pharm-triplixam-shadow game-pharm-patient-shadow" src="images/triplixam-animation/shadow.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-triplixam-legs" src="images/triplixam-animation/legs.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-triplixam-torso" src="images/triplixam-animation/torso.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-triplixam-head" src="images/triplixam-animation/head.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-triplixam-finger" src="images/triplixam-animation/♂finger♂.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-triplixam-phone" src="images/triplixam-animation/phone.png" alt="Part of the patient">
			<img class="game-pharm-animation-image game-pharm-triplixam-hand" src="images/triplixam-animation/hand.png" alt="Part of the patient">
		</div>
	</div>
